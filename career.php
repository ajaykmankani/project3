<?php include("header.php");?>
    ...
    <section class="our-offerings-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6 m-md-auto">
                    <div class="main-our-offerings">
                        <h3>Our Offerings</h3>
                        <p>Stock Benifits offers a variety of paths for growth. Our professionals are assigned on a mix of different opportunities where based on skills, opportunity and the candidate’s desire, the following set of areas are available:</p>
                        <ul>
                            <li>Research Department</li>
                        ...
                        <p>DepartmentWhat we offer as a package is not limited to simply a periodic compensation but very much tied to the ongoing needs of our employees.</p>
                        <ul>
                            <li>Market-competitive compensation</li>
                            <li>Performance based Extra Benefits</li>
                        </ul>
                        <p><b>Kindly Send Your Resume At: amitguruhsachdeva@yahoo.com</b></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <img src="assets/images/main/our-offerings.jpg" alt="" width="100%">
                </div>
            </div>
        </div>
    </section>
