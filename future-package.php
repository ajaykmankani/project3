        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <div class="single-pricing">
                    <div class="pricing">
                        <span class="price">₹ 48616</span>
                        <span class="price-content">HNI Futures </span> 
                    </div>
                    <h2>Future Platinum </h2>
                    <ul>
                        <li><i class="fa fa-check"></i> Get 2-3 ideas daily (Positional + intraday)</li>
                        <li><i class="fa fa-check"></i> Minimum 2 lot trading in each idea</li>
                        <li><i class="fa fa-check"></i> Get Complimentary ideas from AGS </li>
                        <li><i class="fa fa-check"></i> Proper Entry & Exit Level ,Follow Ups & Updates</li>
            ...
            <div class="col-lg-4 col-sm-12">
                <div class="single-pricing popular-plan">
                    <div class="pricing">
                        <span class="price">₹  60770</span>
                        <span class="price-content">HNI </span> 
                    </div>
            ...
            <div class="col-lg-4 col-sm-12">
                <div class="single-pricing">
                    <div class="pricing">
                        <span class="price">₹ 36462</span>
                        <span class="price-content">PPI </span> 
                    </div>
                    <h2>Stock Future Intraday  </h2>
                    <ul>
                        <li><i class="fa fa-check"></i> 1 Idea on a daily Basis with proper SL/TGT</li>
                        <li><i class="fa fa-check"></i> Package will be Active till 40 Positive ideas is delivered</li>
                        <li><i class="fa fa-check"></i> Get Complimentary ideas from AGS </li>
