						...
						<div class="row">
							<div class="col-md-8">
								...
								<div class="form-group row">
								    ...
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="current_pwd" placeholder="Type current password" name="old_pwd">
								    </div>
								</div>
								<div class="form-group row">
								    <label for="inputPassword" class="col-sm-4 col-form-label">New Password</label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="new_pwd" placeholder="Type new password" name="new_pwd">
								    </div>
								</div>
								<div class="form-group row">
								    <label for="inputPassword" class="col-sm-4 col-form-label">Confirm New Password</label>
								    <div class="col-sm-8">
								      <input type="text" class="form-control" id="confirm_pwd" placeholder="Type confirm new password" name="r_pwd">
