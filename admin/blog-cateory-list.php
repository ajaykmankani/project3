...
<head>
	...
	<title>Stock Benefits | Blog Category List</title>
	<!-- Stylesheet -->
		...
		<div class="content-right">
			...
			<div class="main-content">
				...
				<div class="dash-block">
					<h5 class="border-bottom pb-3">All Blog Category <a href="add-blog-category.php"><button type="button" class="btn btn-success btn-sm m-2">Add Blog Category</button></a></h5>
					<div class="form-element mt-2">
					<?php	
					$res = $obj->fetch_all("blog_category",array("*"),"DESC");
					if($res==true){	?>
