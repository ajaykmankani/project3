    ...
    <section class="page-header">
        ...
        <div class="container">
            <ul class="thm-breadcrumb list-unstyled">
                ...
                <li>/</li>
                <li><span>Invester Charter</span></li>
            </ul>
            <h2>Invester Charter</h2>
        </div>
    </section>

    <section class="invester-charter-content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p><b>To provide investment advice to the client based on the risk-profiling of the clients and suitability of the client</b></p>

                    <h3>D.	Details of grievance redressal mechanism and how to access it</h3>
                    <ul>
                        <li>i.	In case of any grievance / complaint, an investor should approach the concerned Investment Adviser and shall ensure that the grievance is resolved within 30 days.</li>
                        <li>ii.	If the investor’s complaint is not redressed satisfactorily, one may lodge a complaint with SEBI on SEBI’s 'SCORES' portal which is a centralized web based complaints redressal system. SEBI takes up the complaints registered via SCORES with the concerned intermediary for timely redressal. SCORES facilitates tracking the status of the complaint.</li>
                        <li>iii. With regard to physical complaints, investors may send their complaints to: Office of Investor Assistance and Education, Securities and Exchange Board of India, SEBI Bhavan, Plot No. C4-A, ‘G’ Block, Bandra-Kurla Complex, Bandra (E), Mumbai - 400 051.</li>
                    </ul>
