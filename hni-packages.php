<?php include('header.php');?>
    ...
    <section class="pricing-main" id="hni-packages">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="single-pricing popular-plan">
                        <div class="pricing">
                            <span class="price">₹ 15450</span>
                            <!-- <span class="price-content">HNI </span> -->
                        </div>
                        <h2>HNI Platinum Delivery </h2>
                        <ul>
                            <li><i class="fa fa-check"></i> 2 ideas on a weekly Basis</li>
                            <li><i class="fa fa-check"></i> Holding Period 8-12 days</li>
                            <li><i class="fa fa-check"></i> Average Return 10-12% on Each Profitable Ideas</li>
