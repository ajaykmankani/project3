<?php include('header.php');?>
    ...
    <section class="pricing-main" id="sb-premium-packages">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="single-pricing popular-plan">
                        <div class="pricing">
                            <!-- <span class="price">₹ 1.25 lakh + GST</span> -->
                            <span class="price-content">₹ 1.25 lakh + GST </span>
                        </div>
                        <h2>SB Premium Combo </h2>
                        <ul>
                            <li><i class="fa fa-check"></i> Get best Ideas from all segments.</li>
                            <li><i class="fa fa-check"></i> Most Profitable Services</li>
                            <li><i class="fa fa-check"></i> Personal Support By our Research Team</li> 
